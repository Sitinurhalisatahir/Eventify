...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-2">Kelola pemesanan untuk acara Anda</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="GET" action="{{ route('organizer.bookings.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <!-- Pencarian -->
            <div>
                ...
                <input 
                    ...
                    placeholder="Kode booking, nama atau email pengguna..."
            ...
            <div class="md:col-span-3 flex justify-end space-x-4 mt-4">
                ...
                <button type="submit" 
                        class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#262363] to-[#262363] text-white rounded-xl hover:from-[#1f1d52] hover:to-[#1f1d52] transition-all duration-300 font-semibold">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800">Pemesanan Acara Saya</h2>
        </div>
